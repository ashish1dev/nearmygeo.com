...
<?php
	function uploadImage($fileName, $maxSize, $maxW, $fullPath, $relPath, $colorR, $colorG, $colorB, $maxH){
		$folder = $relPath;
		$maxlimit = $maxSize;
...
<?php
	if($imgUploaded){
		echo '<img id="item_photo" src="'.$upload_image.'" border="0" />';
	}else{
		echo '<img id="item_photo" src="/addItemToLocation/images/error.gif" width="16" height="16px" border="0" style="marin-bottom: -3px;" /> Error(s) Found: ';
